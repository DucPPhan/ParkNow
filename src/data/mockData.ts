...
export const PARKING_DATA = [
  { id: '1', name: 'Bãi xe Ga Sài Gòn', address: '1 Nguyễn Thông, P. 9, Q. 3', rating: 4.5, imageUrl: require('../assets/image/home_banner.png'), coordinate: { latitude: 10.7850, longitude: 106.6853 }},
  { id: '2', name: 'Bãi xe Nowzone', address: '235 Nguyễn Văn Cừ, P. 4, Q. 5', rating: 4.2, imageUrl: require('../assets/image/home_banner.png'), coordinate: { latitude: 10.7606, longitude: 106.6818 }},
  { id: '3', name: 'Sân bay Tân Sơn Nhất', address: 'Trường Sơn, P. 2, Q. Tân Bình', rating: 4.9, imageUrl: require('../assets/image/home_banner.png'), coordinate: { latitude: 10.8187, longitude: 106.6585 }},
  { id: '4', name: 'Dinh Độc Lập', address: '135 Nam Kỳ Khởi Nghĩa, Q. 1', rating: 4.8, imageUrl: require('../assets/image/home_banner.png'), coordinate: { latitude: 10.7770, longitude: 106.6953 }},
];
